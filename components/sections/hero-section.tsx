    ...
    <section className="flex min-h-[calc(100vh-60px)] items-center justify-center px-5 py-20 md:px-10 lg:px-20">
      <div className="flex w-full max-w-[1040px] flex-col items-center gap-10 md:gap-12 lg:gap-[60px]">
        ...
        <div className="flex w-full flex-col items-center gap-6 text-center">
          ...
          <p className="max-w-[800px] text-base leading-[1.5] tracking-[-0.32px] text-gray-11 md:text-lg md:tracking-[-0.36px]">
        ...
        <div className="flex w-full max-w-[600px] flex-col items-center gap-6">
          ...
          <Link
            href="/demo"
            className="flex h-14 w-full items-center justify-center rounded-xl bg-black px-8 text-base font-semibold leading-normal tracking-[-0.32px] text-white transition-all hover:bg-gray-12/80 hover:shadow-lg md:h-16 md:text-lg"
          >
            See JAY in Action
            <span className="ml-2 text-sm font-normal text-gray-9">(90 seconds)</span>
          </Link>
