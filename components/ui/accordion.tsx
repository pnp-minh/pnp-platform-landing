...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        {showIcon && (icon || <ChevronDownIcon className="text-muted-foreground pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200 [&[data-state=open]]:rotate-180" />)}
      </AccordionPrimitive.Trigger>
